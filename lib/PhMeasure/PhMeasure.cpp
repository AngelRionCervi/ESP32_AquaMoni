...
float PhMeasure::mesurePh() {
  ...
  calibration_phVoltage = avgVoltage;

  float slope = (7.0 - 4.0) / ((phNeutralVoltage - 1500) / 3.0 -
                               (phAcidVoltage - 1500) / 3.0);
...
int PhMeasure::getCalibrationVoltage() {
  return calibration_phVoltage;
}
